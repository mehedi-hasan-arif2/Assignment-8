      ...
      <div className="max-w-md w-full bg-[#111625] border border-gray-800 p-8 rounded-2xl space-y-6 relative">
        ...
        {!isEditing ? (
          <div className="text-center space-y-5">
            {/* Profile Picture or Default Icon Container */}
            ...
            <form onSubmit={handleUpdate} className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-[#0b0f19] border border-gray-800 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-cyan-500" 
                />
              </div>
              <div>
                <label className="block text-xs font-semibold uppercase tracking-wider text-gray-400 mb-1.5 flex items-center gap-1">
                  <Image size={12} /> Profile Image URL
                </label>
                <input 
                  type="url" 
              ...
              <div className="flex gap-3 pt-2">
                <button 
                  ...
                  className="w-1/2 py-2.5 bg-[#0b0f19] border border-gray-800 font-semibold rounded-xl text-sm text-gray-400"
                >
                  Cancel
                </button>
                <button 
                  type="submit" 
                  className="w-1/2 py-2.5 bg-gradient-to-r from-cyan-600 to-violet-600 font-bold rounded-xl text-sm"
                >
                  Save Changes
                </button>
              </div>
